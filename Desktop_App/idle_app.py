...
import getopt
import os
os.chdir("C:\__APP__\Python35\Lib\idlelib")
import os.path
import re
import socket
import subprocess
...
##############################################################################
    ...
    Label(root, text='test').grid(row=2, column=1)
    root.withdraw()
    Label(root, text='test').grid(row=3, column=1)
...
################################################################################
    ...
    if system() == 'Windows':
        iconfile = "C:\__APP__\Python35\Lib\idlelib\Icons\idle.ico"
